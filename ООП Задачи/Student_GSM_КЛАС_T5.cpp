...
public:
	...
	bool function_notequal(Student& p)
	{
		if (p.phone_number != p.phone_number)return true;
		return false;
	}
	bool function_more(Student& p)
	{
		if (this->phone_number < p.phone_number)return true;
		return false;
	}
	bool function_less_or_equal(Student& p)
	{
		if (this->phone_number >= p.phone_number)return true;
		return false;
	}

	bool function_equal(Student& p)
	{
		if (this->phone_number == p.phone_number)return true;
		return false;
	}
